...
namespace
{
	...
	static void nvgRenderFill(void* _userPtr, struct NVGpaint* paint, struct NVGscissor* scissor, const float* xform, float fringe,
...
#ifdef TOYUI_DRAW_CACHE
	static void nvgRenderStroke(void* _userPtr, struct NVGpaint* paint, struct NVGscissor* scissor, const float* xform, float fringe,
								float strokeWidth, const float* bounds, const struct NVGpath* paths, int npaths)
#else
...
#ifdef TOYUI_DRAW_CACHE
	static void nvgRenderTriangles(void* _userPtr, struct NVGpaint* paint, struct NVGscissor* scissor, const float* xform,
		                           const float* bounds, const struct NVGvertex* verts, int nverts)
#else
